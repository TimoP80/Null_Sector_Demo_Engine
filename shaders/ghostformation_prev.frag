#version 300 es
// ---------------------------------------------------------------------------
// SCENE 5 (handoff) - Ghost Formation backdrop.
// The outgoing Infinite Machine frame fades out over the transition window
// while the swarm's particles ignite from its bright circuitry (see
// ghostformation.vert) - the ghost is literally born from the machine it
// escaped. Rendered as the base layer; the cloud draws additively on top, so
// the machine dissolves into the data that becomes the ghost.
// ---------------------------------------------------------------------------
#include <common>
